...
void Command::execute(Client &sender, const std::vector<std::string> &arguments, command_pointer comm)
{
	comm(sender, arguments);
}
...
void Command::validate_pass(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::validate_user(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::validate_nick(Client &sender, const std::vector<std::string> &arguments)
{
	if(sender.getIsPassed() == false)
		throw IRCException(sender.getNick(), " :You have not registered", 451) ; //NotRegistered(sender.getNick());
	if (arguments.size() == 0)
...
void Command::validate_ping(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::validate_pong(Client &sender, const std::vector<std::string> &arguments)
{
	if(sender.isDone() == false)
		throw IRCException(sender.getNick(), " :You have not registered", 451) ; //NotRegistered(sender.getNick());
	if(arguments.size() == 0)
...
void Command::validate_privmsg(Client &sender, const std::vector<std::string> &arguments)
{
	if(sender.isDone() == false)
		throw IRCException(sender.getNick(), " :You have not registered", 451) ; //NotRegistered(sender.getNick());
	MessageController *messageController = MessageController::getController();
...
void Command::validate_join(Client &sender, const std::vector<std::string> &arguments)
{
	if(sender.isDone() == false)
		throw IRCException(sender.getNick(), " :You have not registered", 451) ; //NotRegistered(sender.getNick());
	if(arguments.size() == 0)
...
void Command::validate_part(Client &sender, const std::vector<std::string> &arguments)
{
	if(sender.isDone() == false)
		throw IRCException(sender.getNick(), " :You have not registered", 451) ; //NotRegistered(sender.getNick());
	Server *server = Server::getServer();
...
void Command::validate_kick(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::validate_mode(Client &sender, const std::vector<std::string> &arguments)
{
	if(sender.isDone() == false)
		throw IRCException(sender.getNick(), " :You have not registered", 451) ; //NotRegistered(sender.getNick());
...
void Command::validate_who(Client &sender, const std::vector<std::string> &arguments)
{
	(void) arguments;
	if(sender.isDone() == false)
		throw IRCException(sender.getNick(), " :You have not registered", 451) ; //NotRegistered(sender.getNick());
...
void Command::validate_bot(Client &sender, const std::vector<std::string> &arguments)
{
	if(sender.isDone() == false)
		throw IRCException(sender.getNick(), " :You have not registered", 451) ; //NotRegistered(sender.getNick());
	Server *server = Server::getServer();
...
void Command::execute_pass(Client &sender, const std::vector<std::string> &arguments)
{
	validate_pass(sender, arguments);
	(void) arguments;
	sender.setIsPassed(true);
}
void Command::execute_user(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::execute_nick(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::execute_ping(Client &sender, const std::vector<std::string> &arguments)
{
	validate_ping(sender, arguments);
	sender.SendPongMessage(arguments[0]);
}
void Command::execute_pong(Client &sender, const std::vector<std::string> &arguments)
{
	validate_pong(sender, arguments);
	sender.SendPongMessage(arguments[0]);
}
void Command::execute_privmsg(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::execute_notice(Client &sender, const std::vector<std::string> &arguments)
{
	if(sender.isDone() == false)
		return ;
	MessageController *messageController = MessageController::getController();
...
void Command::execute_join(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::execute_part(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::execute_kick(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::execute_quit(Client &sender, const std::vector<std::string> &arguments)
{
	ClientManager *manager = ClientManager::getManager();
...
void Command::execute_mode(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::execute_who(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::execute_bot(Client &sender, const std::vector<std::string> &arguments)
{
...
void Command::execute_botme(Client &sender, const std::vector<std::string> &arguments)
{
	(void) arguments;
	Server::getServer()->SetBotDescriptor(sender.getSocket());
}
void Command::execute_ftp(Client &sender, const std::vector<std::string> &arguments)
{
