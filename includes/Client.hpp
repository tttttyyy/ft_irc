...
class Client
{
	...
	public:
		...
		void		SendMessage(const Client &reciever, const std::string &commmand, const std::string message) const;
		void		SendPongMessage(const std::string &message) const;
		void		SendSelf(const std::string &message) const;


		void		SendMessageFromChannel(const Client &reciever, const std::string &command,	const std::string &channel, const std::string message) const;
